...
```
git clone https://github.com/sooperNoob/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:sooperNoob/CppND-Route-Planning-Project.git --recurse-submodules
```
